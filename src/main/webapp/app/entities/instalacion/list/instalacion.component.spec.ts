...
describe('Instalacion Management Component', () => {
  let comp: InstalacionComponent;
  let fixture: ComponentFixture<InstalacionComponent>;
  let service: InstalacionService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'instalacion', component: InstalacionComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(InstalacionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.instalacions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
