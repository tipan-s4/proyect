...
describe('Penalizacion Management Component', () => {
  let comp: PenalizacionComponent;
  let fixture: ComponentFixture<PenalizacionComponent>;
  let service: PenalizacionService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'penalizacion', component: PenalizacionComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PenalizacionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.penalizacions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
